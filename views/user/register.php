...
<main class="form-signin">
    ...
    <form action="" method="POST">
        ...
        <select name="role" class="reg-form form-control form-select-lg mb-3 select_role" aria-label="Default select example">
            <option class="form-control" selected value="">Select role</option>
